...
<html lang="en">
  ...
  <c:import url="./template/header.jsp"></c:import>
    ...
    <section class="container-fluid-lg-8">
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item" data-bs-interval="700">
                <img src="/resources/images/cat2.jpg" class="d-block w-100" alt="..." width="850px" height="850px">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item" data-bs-interval="700">
                <img src="/resources/images/cat.jpg" class="d-block w-100" alt="..." width="800px" height="800px">
                <div class="carousel-caption d-none d-md-block">
