...
public class BankBookDAO implements BookDAO{
	...
	public final String NAMESPACE = "com.iu.start.bankBook.BankBookDAO.";
...
//		DBConnector.disConnect(st, con);
		...
		return sqlSession.insert(NAMESPACE+"setChangeSale" ,bankBookDTO);
	}
...
//		DBConnector.disConnect(st, con);
		...
		return sqlSession.insert(NAMESPACE+"setUpdate",bankBookDTO);
	}
...
//		DBConnector.disConnect(st, con);
		...
		return sqlSession.insert(NAMESPACE+"setDelete",bankBookDTO);
	}
